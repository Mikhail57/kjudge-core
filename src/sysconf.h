...
#ifndef KJUDGE_CORE_SYSCONF_H
#define KJUDGE_CORE_SYSCONF_H

/* Platform identifiers */

/* Detect Unix. */
#if defined(unix) || defined(__unix__) || defined(__linux__) || defined(BSD) || defined(__CYGWIN__) || defined(macosx) || defined(__APPLE__)
